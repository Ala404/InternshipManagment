...
<template >
  ...
  >
    ...
    <div class="">
      ...
      <Menu ref="menu" id="overlay_menu" :model="items" :popup="true" class="w-56 h-56 overflow-y-scroll menu-width" :style="{ width: '300px' }"/>
...
export default {
  ...
  mounted() {
    ...
    axios
      .post("http://localhost:8000/api/unseenChefNotifNbr", {
        id: 1,
      })
      .then((response) => {
        // Assign the notifications to the component's data property
