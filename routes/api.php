...
Route::post('/listeStagiairs', [ResponsableController::class, 'listeStagiairs']);
...
Route::post('/getMotif', [ChefController::class, 'getMotif']);
...
Route::post('/successfulInternsList', [ResponsableController::class, 'successfulInternsList']);
...
Route::post('/deleteNotification', [EtudiantController::class, 'deleteNotification']);
